...
class ChatService:
    ...
    def _agent_system_prompt(self, state: ChatSessionState) -> str:
        ...
        prompt = (
            ...
            "Use run_backtest when the user asks to backtest the strategy, review historical performance, or simulate the setup on past candles. "
            ...
            "When run_backtest succeeds, the final answer should match the generated terminal report without extra markdown. "
